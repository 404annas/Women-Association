...
const About = () => {
  return (
    <div className="px-16 pt-20 pb-10 min-h-screen bg-gradient-to-br from-green-50 to-cyan-50">
      <div className="flex items-center">
        <div className="w-1/2">
          <h1 className="tim font-extrabold text-4xl text-[#413C3A]">
            Serving the Pakistani community
          </h1>
          <p className="p-regular text-gray-700 text-base py-6">
          ...
          <p className="p-regular text-gray-700 text-base pb-6">
          ...
          <p className="p-regular text-gray-700 text-base pb-8">
            Join us and raise the{" "}
            <span className="text-gray-800 font-semibold">
              slogan #TogetherWeWillRise
            </span>
          </p>
          <h1 className="cav text-5xl text-gray-800">Shafaq Jaffery</h1>
          <p className="p-medium text-base pl-2 pt-2 text-gray-800">
            Founder & CEO
          </p>
        </div>
        <div className="w-1/2 flex flex-col items-center justify-center">
          <div className="relative w-96 h-96">
            {/* Outer Blue Border */}
            {/* <div className="absolute inset-0 rounded-full bg-blue-500 p-2"> */}
            {/* Inner Green Border with Cut */}
            <div className="w-full h-full rounded-full bg-green-500 p-1 relative z-0">
              <div className="relative w-full h-full rounded-full bg-white p-2">
                {/* Image */}
                <img
